...
func gsParserInit() {
  ...
  staticData.SymbolicNames = []string{
    ...
    "ADD", "SUB", "MUL", "DIV", "MOD", "POW", "EQ", "LT", "GT", "GEQ", "LEQ", 
    "NEQ", "BITAND", "BITOR", "XOR", "INCR", "DECR", "DOT", "LBRACK", "LPAREN", 
  ...
  staticData.serializedATN = []int32{
	4, 1, 63, 445, 2, 0, 7, 0, 2, 1, 7, 1, 2, 2, 7, 2, 2, 3, 7, 3, 2, 4, 7, 
	...
	40, 42, 44, 46, 48, 50, 52, 54, 56, 58, 60, 62, 64, 66, 68, 70, 0, 11, 
	2, 0, 54, 54, 60, 60, 1, 0, 44, 45, 1, 0, 3, 7, 2, 0, 9, 10, 56, 58, 2, 
	0, 27, 27, 46, 46, 2, 0, 28, 28, 47, 47, 2, 0, 8, 8, 63, 63, 1, 0, 35, 
	40, 1, 0, 29, 30, 1, 0, 41, 43, 1, 0, 31, 33, 485, 0, 75, 1, 0, 0, 0, 2, 
	81, 1, 0, 0, 0, 4, 95, 1, 0, 0, 0, 6, 111, 1, 0, 0, 0, 8, 201, 1, 0, 0, 
	0, 10, 203, 1, 0, 0, 0, 12, 220, 1, 0, 0, 0, 14, 227, 1, 0, 0, 0, 16, 229, 
	1, 0, 0, 0, 18, 231, 1, 0, 0, 0, 20, 233, 1, 0, 0, 0, 22, 240, 1, 0, 0, 
	0, 24, 242, 1, 0, 0, 0, 26, 244, 1, 0, 0, 0, 28, 261, 1, 0, 0, 0, 30, 263, 
	1, 0, 0, 0, 32, 271, 1, 0, 0, 0, 34, 279, 1, 0, 0, 0, 36, 285, 1, 0, 0, 
	0, 38, 294, 1, 0, 0, 0, 40, 303, 1, 0, 0, 0, 42, 312, 1, 0, 0, 0, 44, 340, 
	1, 0, 0, 0, 46, 342, 1, 0, 0, 0, 48, 358, 1, 0, 0, 0, 50, 367, 1, 0, 0, 
	0, 52, 373, 1, 0, 0, 0, 54, 396, 1, 0, 0, 0, 56, 398, 1, 0, 0, 0, 58, 420, 
	1, 0, 0, 0, 60, 432, 1, 0, 0, 0, 62, 434, 1, 0, 0, 0, 64, 436, 1, 0, 0, 
	0, 66, 438, 1, 0, 0, 0, 68, 440, 1, 0, 0, 0, 70, 442, 1, 0, 0, 0, 72, 76, 
	...
	1, 1, 0, 0, 0, 81, 82, 5, 22, 0, 0, 82, 83, 5, 63, 0, 0, 83, 84, 5, 23, 
	0, 0, 84, 85, 5, 50, 0, 0, 85, 90, 5, 63, 0, 0, 86, 87, 5, 55, 0, 0, 87, 
	89, 5, 63, 0, 0, 88, 86, 1, 0, 0, 0, 89, 92, 1, 0, 0, 0, 90, 88, 1, 0, 
	0, 0, 90, 91, 1, 0, 0, 0, 91, 93, 1, 0, 0, 0, 92, 90, 1, 0, 0, 0, 93, 94, 
	5, 51, 0, 0, 94, 3, 1, 0, 0, 0, 95, 96, 5, 21, 0, 0, 96, 97, 5, 63, 0, 
	0, 97, 106, 5, 48, 0, 0, 98, 103, 5, 63, 0, 0, 99, 100, 5, 55, 0, 0, 100, 
	102, 5, 63, 0, 0, 101, 99, 1, 0, 0, 0, 102, 105, 1, 0, 0, 0, 103, 101, 
	1, 0, 0, 0, 103, 104, 1, 0, 0, 0, 104, 107, 1, 0, 0, 0, 105, 103, 1, 0, 
	0, 0, 106, 98, 1, 0, 0, 0, 106, 107, 1, 0, 0, 0, 107, 108, 1, 0, 0, 0, 
	108, 109, 5, 49, 0, 0, 109, 110, 3, 6, 3, 0, 110, 5, 1, 0, 0, 0, 111, 123, 
	5, 50, 0, 0, 112, 119, 3, 8, 4, 0, 113, 115, 7, 0, 0, 0, 114, 113, 1, 0, 
	...
	0, 0, 124, 126, 1, 0, 0, 0, 125, 123, 1, 0, 0, 0, 126, 127, 5, 51, 0, 0, 
	127, 7, 1, 0, 0, 0, 128, 202, 5, 54, 0, 0, 129, 202, 3, 2, 1, 0, 130, 202, 
	3, 10, 5, 0, 131, 202, 3, 20, 10, 0, 132, 202, 3, 12, 6, 0, 133, 142, 5, 
	20, 0, 0, 134, 139, 3, 28, 14, 0, 135, 136, 5, 55, 0, 0, 136, 138, 3, 28, 
	14, 0, 137, 135, 1, 0, 0, 0, 138, 141, 1, 0, 0, 0, 139, 137, 1, 0, 0, 0, 
	139, 140, 1, 0, 0, 0, 140, 143, 1, 0, 0, 0, 141, 139, 1, 0, 0, 0, 142, 
	134, 1, 0, 0, 0, 142, 143, 1, 0, 0, 0, 143, 202, 1, 0, 0, 0, 144, 145, 
	5, 17, 0, 0, 145, 150, 3, 28, 14, 0, 146, 147, 5, 55, 0, 0, 147, 149, 3, 
	28, 14, 0, 148, 146, 1, 0, 0, 0, 149, 152, 1, 0, 0, 0, 150, 148, 1, 0, 
	0, 0, 150, 151, 1, 0, 0, 0, 151, 202, 1, 0, 0, 0, 152, 150, 1, 0, 0, 0, 
	153, 154, 5, 1, 0, 0, 154, 159, 3, 28, 14, 0, 155, 156, 5, 55, 0, 0, 156, 
	158, 3, 28, 14, 0, 157, 155, 1, 0, 0, 0, 158, 161, 1, 0, 0, 0, 159, 157, 
	1, 0, 0, 0, 159, 160, 1, 0, 0, 0, 160, 202, 1, 0, 0, 0, 161, 159, 1, 0, 
	0, 0, 162, 166, 5, 15, 0, 0, 163, 164, 3, 10, 5, 0, 164, 165, 5, 54, 0, 
	0, 165, 167, 1, 0, 0, 0, 166, 163, 1, 0, 0, 0, 166, 167, 1, 0, 0, 0, 167, 
	168, 1, 0, 0, 0, 168, 169, 3, 28, 14, 0, 169, 172, 3, 6, 3, 0, 170, 171, 
	5, 16, 0, 0, 171, 173, 3, 6, 3, 0, 172, 170, 1, 0, 0, 0, 172, 173, 1, 0, 
	0, 0, 173, 202, 1, 0, 0, 0, 174, 176, 5, 18, 0, 0, 175, 177, 3, 16, 8, 
	0, 176, 175, 1, 0, 0, 0, 176, 177, 1, 0, 0, 0, 177, 178, 1, 0, 0, 0, 178, 
	180, 5, 54, 0, 0, 179, 181, 3, 28, 14, 0, 180, 179, 1, 0, 0, 0, 180, 181, 
	1, 0, 0, 0, 181, 182, 1, 0, 0, 0, 182, 184, 5, 54, 0, 0, 183, 185, 3, 18, 
	9, 0, 184, 183, 1, 0, 0, 0, 184, 185, 1, 0, 0, 0, 185, 186, 1, 0, 0, 0, 
	186, 202, 3, 6, 3, 0, 187, 188, 5, 18, 0, 0, 188, 189, 3, 14, 7, 0, 189, 
	190, 5, 2, 0, 0, 190, 191, 5, 19, 0, 0, 191, 192, 3, 28, 14, 0, 192, 193, 
	3, 6, 3, 0, 193, 202, 1, 0, 0, 0, 194, 195, 5, 18, 0, 0, 195, 196, 3, 28, 
	14, 0, 196, 197, 3, 6, 3, 0, 197, 202, 1, 0, 0, 0, 198, 202, 3, 26, 13, 
	0, 199, 202, 5, 25, 0, 0, 200, 202, 5, 26, 0, 0, 201, 128, 1, 0, 0, 0, 
	...
	205, 5, 55, 0, 0, 205, 207, 3, 58, 29, 0, 206, 204, 1, 0, 0, 0, 207, 210, 
	1, 0, 0, 0, 208, 206, 1, 0, 0, 0, 208, 209, 1, 0, 0, 0, 209, 211, 1, 0, 
	0, 0, 210, 208, 1, 0, 0, 0, 211, 212, 5, 2, 0, 0, 212, 217, 3, 28, 14, 
	0, 213, 214, 5, 55, 0, 0, 214, 216, 3, 28, 14, 0, 215, 213, 1, 0, 0, 0, 
	216, 219, 1, 0, 0, 0, 217, 215, 1, 0, 0, 0, 217, 218, 1, 0, 0, 0, 218, 
	11, 1, 0, 0, 0, 219, 217, 1, 0, 0, 0, 220, 221, 3, 58, 29, 0, 221, 222, 
	7, 1, 0, 0, 222, 13, 1, 0, 0, 0, 223, 228, 5, 63, 0, 0, 224, 225, 5, 63, 
	0, 0, 225, 226, 5, 55, 0, 0, 226, 228, 5, 63, 0, 0, 227, 223, 1, 0, 0, 
	...
	245, 5, 63, 0, 0, 245, 257, 5, 48, 0, 0, 246, 251, 3, 28, 14, 0, 247, 248, 
	5, 55, 0, 0, 248, 250, 3, 28, 14, 0, 249, 247, 1, 0, 0, 0, 250, 253, 1, 
	0, 0, 0, 251, 249, 1, 0, 0, 0, 251, 252, 1, 0, 0, 0, 252, 255, 1, 0, 0, 
	0, 253, 251, 1, 0, 0, 0, 254, 256, 5, 55, 0, 0, 255, 254, 1, 0, 0, 0, 255, 
	256, 1, 0, 0, 0, 256, 258, 1, 0, 0, 0, 257, 246, 1, 0, 0, 0, 257, 258, 
	1, 0, 0, 0, 258, 259, 1, 0, 0, 0, 259, 260, 5, 49, 0, 0, 260, 27, 1, 0, 
	0, 0, 261, 262, 3, 30, 15, 0, 262, 29, 1, 0, 0, 0, 263, 268, 3, 32, 16, 
	0, 264, 265, 5, 13, 0, 0, 265, 267, 3, 32, 16, 0, 266, 264, 1, 0, 0, 0, 
	267, 270, 1, 0, 0, 0, 268, 266, 1, 0, 0, 0, 268, 269, 1, 0, 0, 0, 269, 
	31, 1, 0, 0, 0, 270, 268, 1, 0, 0, 0, 271, 276, 3, 34, 17, 0, 272, 273, 
	5, 12, 0, 0, 273, 275, 3, 34, 17, 0, 274, 272, 1, 0, 0, 0, 275, 278, 1, 
	...
	22, 0, 313, 314, 5, 34, 0, 0, 314, 316, 3, 44, 22, 0, 315, 313, 1, 0, 0, 
	0, 316, 319, 1, 0, 0, 0, 317, 315, 1, 0, 0, 0, 317, 318, 1, 0, 0, 0, 318, 
	43, 1, 0, 0, 0, 319, 317, 1, 0, 0, 0, 320, 321, 5, 30, 0, 0, 321, 341, 
	3, 44, 22, 0, 322, 341, 5, 56, 0, 0, 323, 341, 5, 57, 0, 0, 324, 341, 5, 
	58, 0, 0, 325, 341, 5, 9, 0, 0, 326, 341, 5, 10, 0, 0, 327, 341, 5, 11, 
	0, 0, 328, 329, 5, 14, 0, 0, 329, 341, 3, 28, 14, 0, 330, 341, 3, 58, 29, 
	0, 331, 341, 3, 26, 13, 0, 332, 341, 3, 56, 28, 0, 333, 341, 3, 46, 23, 
	0, 334, 341, 3, 48, 24, 0, 335, 341, 3, 52, 26, 0, 336, 337, 5, 48, 0, 
	0, 337, 338, 3, 28, 14, 0, 338, 339, 5, 49, 0, 0, 339, 341, 1, 0, 0, 0, 
	...
	5, 47, 0, 0, 343, 348, 3, 28, 14, 0, 344, 345, 5, 55, 0, 0, 345, 347, 3, 
	28, 14, 0, 346, 344, 1, 0, 0, 0, 347, 350, 1, 0, 0, 0, 348, 346, 1, 0, 
	0, 0, 348, 349, 1, 0, 0, 0, 349, 352, 1, 0, 0, 0, 350, 348, 1, 0, 0, 0, 
	351, 353, 5, 55, 0, 0, 352, 351, 1, 0, 0, 0, 352, 353, 1, 0, 0, 0, 353, 
	355, 1, 0, 0, 0, 354, 343, 1, 0, 0, 0, 354, 355, 1, 0, 0, 0, 355, 356, 
	1, 0, 0, 0, 356, 357, 5, 52, 0, 0, 357, 47, 1, 0, 0, 0, 358, 359, 3, 58, 
	29, 0, 359, 362, 5, 47, 0, 0, 360, 363, 3, 28, 14, 0, 361, 363, 3, 50, 
	25, 0, 362, 360, 1, 0, 0, 0, 362, 361, 1, 0, 0, 0, 363, 364, 1, 0, 0, 0, 
	364, 365, 5, 52, 0, 0, 365, 49, 1, 0, 0, 0, 366, 368, 3, 28, 14, 0, 367, 
	366, 1, 0, 0, 0, 367, 368, 1, 0, 0, 0, 368, 369, 1, 0, 0, 0, 369, 371, 
	5, 53, 0, 0, 370, 372, 3, 28, 14, 0, 371, 370, 1, 0, 0, 0, 371, 372, 1, 
	0, 0, 0, 372, 51, 1, 0, 0, 0, 373, 385, 5, 50, 0, 0, 374, 379, 3, 54, 27, 
	0, 375, 376, 5, 55, 0, 0, 376, 378, 3, 54, 27, 0, 377, 375, 1, 0, 0, 0, 
	378, 381, 1, 0, 0, 0, 379, 377, 1, 0, 0, 0, 379, 380, 1, 0, 0, 0, 380, 
	383, 1, 0, 0, 0, 381, 379, 1, 0, 0, 0, 382, 384, 5, 55, 0, 0, 383, 382, 
	1, 0, 0, 0, 383, 384, 1, 0, 0, 0, 384, 386, 1, 0, 0, 0, 385, 374, 1, 0, 
	0, 0, 385, 386, 1, 0, 0, 0, 386, 387, 1, 0, 0, 0, 387, 388, 5, 51, 0, 0, 
	388, 53, 1, 0, 0, 0, 389, 390, 7, 3, 0, 0, 390, 391, 5, 53, 0, 0, 391, 
	397, 3, 28, 14, 0, 392, 393, 3, 58, 29, 0, 393, 394, 5, 53, 0, 0, 394, 
	395, 3, 28, 14, 0, 395, 397, 1, 0, 0, 0, 396, 389, 1, 0, 0, 0, 396, 392, 
	1, 0, 0, 0, 397, 55, 1, 0, 0, 0, 398, 399, 5, 24, 0, 0, 399, 400, 5, 63, 
	0, 0, 400, 416, 5, 50, 0, 0, 401, 402, 5, 63, 0, 0, 402, 403, 5, 53, 0, 
	0, 403, 410, 3, 28, 14, 0, 404, 405, 5, 55, 0, 0, 405, 406, 5, 63, 0, 0, 
	406, 407, 5, 53, 0, 0, 407, 409, 3, 28, 14, 0, 408, 404, 1, 0, 0, 0, 409, 
	412, 1, 0, 0, 0, 410, 408, 1, 0, 0, 0, 410, 411, 1, 0, 0, 0, 411, 414, 
	1, 0, 0, 0, 412, 410, 1, 0, 0, 0, 413, 415, 5, 55, 0, 0, 414, 413, 1, 0, 
	0, 0, 414, 415, 1, 0, 0, 0, 415, 417, 1, 0, 0, 0, 416, 401, 1, 0, 0, 0, 
	416, 417, 1, 0, 0, 0, 417, 418, 1, 0, 0, 0, 418, 419, 5, 51, 0, 0, 419, 
	57, 1, 0, 0, 0, 420, 429, 3, 60, 30, 0, 421, 422, 7, 4, 0, 0, 422, 428, 
	5, 63, 0, 0, 423, 424, 7, 5, 0, 0, 424, 425, 3, 28, 14, 0, 425, 426, 5, 
	52, 0, 0, 426, 428, 1, 0, 0, 0, 427, 421, 1, 0, 0, 0, 427, 423, 1, 0, 0, 
	0, 428, 431, 1, 0, 0, 0, 429, 427, 1, 0, 0, 0, 429, 430, 1, 0, 0, 0, 430, 
	59, 1, 0, 0, 0, 431, 429, 1, 0, 0, 0, 432, 433, 7, 6, 0, 0, 433, 61, 1, 
	0, 0, 0, 434, 435, 7, 7, 0, 0, 435, 63, 1, 0, 0, 0, 436, 437, 7, 8, 0, 
	0, 437, 65, 1, 0, 0, 0, 438, 439, 7, 9, 0, 0, 439, 67, 1, 0, 0, 0, 440, 
	441, 7, 10, 0, 0, 441, 69, 1, 0, 0, 0, 442, 443, 5, 34, 0, 0, 443, 71, 
	1, 0, 0, 0, 48, 75, 77, 90, 103, 106, 116, 119, 123, 139, 142, 150, 159, 
	166, 172, 176, 180, 184, 201, 208, 217, 227, 240, 251, 255, 257, 268, 276, 
	283, 291, 300, 309, 317, 340, 348, 352, 354, 362, 367, 371, 379, 383, 385, 
	396, 410, 414, 416, 427, 429,
}
...
func (p *GsParser) Program() (localctx IProgramContext) {
	...
	for ok := true; ok; ok = ((int64(_la) & ^0x3f) == 0 && ((int64(1) << _la) & -9205357638236864254) != 0) {
		p.SetState(75)
		p.GetErrorHandler().Sync(p)
		if p.HasError() {
			goto errorExit
...
func (p *GsParser) Block() (localctx IBlockContext) {
	...
	for ((int64(_la) & ^0x3f) == 0 && ((int64(1) << _la) & -9205357638238961406) != 0) {
		{
			p.SetState(112)
			p.Statement()
		}
...
func (p *GsParser) Statement() (localctx IStatementContext) {
	...
	case 10:
		...
		if ((int64(_la) & ^0x3f) == 0 && ((int64(1) << _la) & -8717420765126832384) != 0) {
			{
				p.SetState(179)
				p.Expr()
			}
...
func (p *GsParser) DictLiteral() (localctx IDictLiteralContext) {
	...
	if ((int64(_la) & ^0x3f) == 0 && ((int64(1) << _la) & -8718968878589278464) != 0) {
		{
			p.SetState(374)
			p.DictEntry()
		}
...
func (p *GsParser) DictEntry() (localctx IDictEntryContext) {
	...
	case GsParserTRUE, GsParserFALSE, GsParserINT, GsParserFLOAT, GsParserSTRING:
		...
		p.EnterOuterAlt(localctx, 1)
		{
			...
			if !(((int64(_la) & ^0x3f) == 0 && ((int64(1) << _la) & 504403158265497088) != 0)) {
				p.GetErrorHandler().RecoverInline(p)
			} else {
				p.GetErrorHandler().ReportMatch(p)
				p.Consume()
